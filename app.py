...
CONFIG = {
    ...
    "NOME_PROFISSIONAL": "Dra. Maria Julia Remor",
    "BIO_CURTA": "Especialista em Harmonização Facial dedicada a transformar vidas através de técnicas seguras e resultados naturais. Com vasta experiência clínica, a Dra. Maria Julia compartilha seu conhecimento para formar profissionais de excelência no mercado da estética.",
    ...
    "CONTATO": "@dramariajuliaremor",
    "FOTO_PROFISSIONAL": "dra_maria_julia.jpg", # Foto atualizada
    "CORES": {
...
def section_about():
    ...
    with col1:
        ...
        foto_path = CONFIG['FOTO_PROFISSIONAL']
        if os.path.exists(foto_path):
            st.image(foto_path, use_container_width=True, caption=f"Mentora {CONFIG['NOME_PROFISSIONAL']}")
        else:
            # Fallback caso a imagem não seja encontrada
            st.warning("Imagem não encontrada. Verifique se o arquivo está na mesma pasta do app.py")
            st.image("https://via.placeholder.com/400x500?text=Foto+Nao+Encontrada")
    with col2:
