...
CONFIG = {
    ...
    "FOTO_PROFISSIONAL": "https://via.placeholder.com/400x500?text=Sua+Foto+Aqui", # Substitua por um link de imagem real
    "CORES": {
...
def section_about():
    ...
    with col1:
        # Exibe a foto da profissional definida nas configurações
        st.image(CONFIG['FOTO_PROFISSIONAL'], use_container_width=True, caption=f"Mentora {CONFIG['NOME_PROFISSIONAL']}")
    with col2:
